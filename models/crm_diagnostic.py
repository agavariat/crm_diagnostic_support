...
class CrmDiagnostic(models.Model):
    ...
    def _get_chart(self):
        for diagnostic in self:
            ...
            diagnostic.puntaje_pplanear = round((planear/65)*100)
            diagnostic.puntaje_phacer = round((hacer/60)*100)
            diagnostic.puntaje_pverificar = round((verificar/15)*100)
            diagnostic.puntaje_pactuar = round((actuar/10)*100)
            diagnostic.porcentaje_total = round(((planear + hacer + verificar + actuar)/150)*100)
